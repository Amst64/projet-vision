...
g++ -std=c++11 -O0`pkg-config --cflags opencv` projet_base.cpp `pkg-config --libs opencv` -o projet_base # commande pour compiler le code 
./projet_base 480 640 5 >> result.txt #rows, cols, n      
g++ -std=c++11 -O1`pkg-config --cflags opencv` projet_base.cpp `pkg-config --libs opencv` -o projet_base # commande pour compiler le code 
./projet_base 480 640 5 >> result.txt #rows, cols, n      
g++ -std=c++11 -O2`pkg-config --cflags opencv` projet_base.cpp `pkg-config --libs opencv` -o projet_base # commande pour compiler le code 
./projet_base 480 640 5 >> result.txt #rows, cols, n      
g++ -std=c++11 -O3`pkg-config --cflags opencv` projet_base.cpp `pkg-config --libs opencv` -o projet_base # commande pour compiler le code 
./projet_base 480 640 5 >> result.txt #rows, cols, n      
echo "*********************************************************************" >> result.txt 
